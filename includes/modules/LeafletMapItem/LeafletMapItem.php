...
class Supreme_LeafletMapItem extends ET_Builder_Module {
	...
	public function get_fields() {
		return array(
			'admin_title'        => array(
				'label'       => esc_html__( 'Admin Label', 'supreme-maps' ),
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the leaflet item in the builder for easy identification.', 'supreme-maps' ),
	...
	public function render( $attrs, $content, $render_slug ) {
		...
		$address_custom_lat = str_replace( ' ', '', $this->props['address_custom_lat'] );
		$address_custom_lng = str_replace( ' ', '', $this->props['address_custom_lng'] );
