...
class Supreme_GoogleMapItem extends ET_Builder_Module {
	...
	public function init() {
		...
		$this->plural                   = esc_html__( 'Google Pins', 'supreme-maps' );
	...
	function get_fields() {
		$fields = array(
			'admin_title'       => array(
				...
				'type'        => 'text',
				'description' => esc_html__( 'This will change the label of the google map item in the builder for easy identification.', 'supreme-maps' ),
